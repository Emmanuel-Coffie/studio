...
export const experienceData: Experience[] = [
  {
    id: 'exp-ecg',
    title: 'Corporate Planning National Service Personnel',
    organization: 'Electricity Company Ghana Ltd.',
    period: 'Nov. 2024 – Dec. 2025',
    description: 'Contributing to strategic corporate planning and IT initiatives as part of the National Service Scheme.',
    type: 'work',
  },
  {
    id: 'exp-mofa',
    ...
    description: 'Supported IT infrastructure, provided technical assistance, and contributed to departmental technology projects.',
    type: 'work',
  },
  {
    id: 'exp-umatt',
    title: 'B.Sc. in Computer Science & Engineering',
    organization: 'University of Mines and Technology',
    period: '2021 - 2024',
    description: 'Focused on software engineering, data systems, and technical problem-solving. Graduated with honors.',
    type: 'education',
  },
  {
    id: 'exp-huawei',
    ...
    period: '2022',
    description: 'Earned certification in core ICT principles, including networking and routing/switching.',
    type: 'achievement',
  },
  {
    id: 'exp-gcaa',
    ...
    description: 'Gained hands-on experience in the software development lifecycle within a critical infrastructure environment.',
    type: 'work',
  },
];
